...
def kitchen_kettle_run(state: bool):
...
def initiateCharacter(character: dict):
    """Generate a new charater given an object of:

    dict kwargs:
        name: The name of the character
        purpose: The purpose of the character
        principles: The guiding principles of the chatacter
    """
    print('Run code.')


def kitchen_heater_status():
    """Get the current status of the kitchen heater
