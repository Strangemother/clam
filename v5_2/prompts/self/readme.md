...
```mermaid
flowchart TD
    A[Meta Reflective Layer<br/>Self-Inference & Observation] --> B[Counter Reflective Layer<br/>Adversarial Scrutiny]
    B --> C[Integrative Synthesis Layer<br/>Provisional Self-Model]
    C --> D[Executive Governance Layer<br/>Expression Regulation]
    ...
    style D fill:#fff5e1,stroke:#be7700,stroke-width:2px
    style E fill:#f5e1ff,stroke:#7700be,stroke-width:2px
    style F fill:#ffe1f5,stroke:#be0077,stroke-width:2px
```
