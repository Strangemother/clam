...
function makeGradVoiceIndexTTS2Panel(id, p = {}) {
    return {
        ...
        pipsInbound:  [
            ...
            { label: id, index: 3, name: 'happy' },
            { label: id, index: 4, name: 'angry' },
            { label: id, index: 5, name: 'sad' },
            { label: id, index: 6, name: 'afraid' },
            { label: id, index: 7, name: 'disgusted' },
            { label: id, index: 8, name: 'melancholic' },
            { label: id, index: 9, name: 'surprised' },
            { label: id, index: 10, name: 'calm' },
        ],
        pipsOutbound: [{ label: id, index: 0, name: 'out' }],
    }
}
